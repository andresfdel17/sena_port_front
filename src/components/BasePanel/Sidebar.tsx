...
export const Sidebar = (props: any) => {
    ...
    const NavItem = (props: INavItem) => {
        ...
        const classNames: string = badgeText ? "d-flex justify-content-start align-items-center justify-content-between" : "";
        const navItemClassName: string = link === pathname ? "active" : "";
        const linkProps: IHref | ILink = external ? { href: link } : { as: Link, to: link };
        return (
